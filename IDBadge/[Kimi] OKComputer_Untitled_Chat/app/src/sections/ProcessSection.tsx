      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="text-center mb-10">
          ...
          <p
            ...
            style={{ color: '#6B7280', maxWidth: '640px' }}
          >
        ...
        >
          {TABS.map((tab) => (
            <button
              ...
              style={{
                color: activeTab === tab.id ? '#1A2B4C' : '#6B7280',
              }}
              onMouseEnter={(e) => {
                if (activeTab !== tab.id) (e.target as HTMLElement).style.color = '#374151';
              }}
              onMouseLeave={(e) => {
                if (activeTab !== tab.id) (e.target as HTMLElement).style.color = '#6B7280';
              }}
            >
              {tab.label}
            </button>
        ...
        >
          ...
          {activeTab === 'overview' && (
            <div className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-8">
              <div>
                <h3 className="font-semibold text-xl mb-5" style={{ color: '#1A2B4C' }}>
                  Process at a Glance
                </h3>
                ...
                <p className="text-base font-medium mb-3" style={{ color: '#374151' }}>
                  ...
                  {KEY_POINTS.map((point, idx) => (
                    <li key={idx} className="flex items-start gap-3">
                      <span
                        ...
                        style={{ backgroundColor: '#C8962E' }}
                      />
                      <span className="text-base leading-relaxed" style={{ color: '#374151' }}>
                        {point}
                      </span>
                    </li>
                  ))}
          ...
          {activeTab === 'onboarding' && (
            <div>
              <h3 className="font-semibold text-xl mb-2" style={{ color: '#1A2B4C' }}>
            ...
            <div>
              ...
              <div className="text-center mt-6">
                ...
                <button
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.backgroundColor = '#1A2B4C';
                    e.currentTarget.style.color = '#fff';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.backgroundColor = 'transparent';
                    e.currentTarget.style.color = '#1A2B4C';
                  }}
                >
