...
export default function InfoCard() {
  return (
    ...
    >
      <Shield size={48} style={{ color: '#1A2B4C' }} className="mb-4" />
      <h3 className="font-semibold text-xl mb-4" style={{ color: '#1A2B4C' }}>
      ...
      <div className="flex flex-col">
        {departments.map((dept, idx) => (
          <div
            ...
            className="py-4"
            style={{
              borderBottom: idx < departments.length - 1 ? '1px solid #E5E7EB' : 'none',
            }}
          >
            <p className="font-semibold text-sm mb-1" style={{ color: '#1A2B4C' }}>
              {dept.name}
            </p>
